# 4.7 Creating Player, We will add a animation changer which will change the animation of the player
# based on the action of the player, like running, jumping and ducking
