# 6.1 Creating birds, We will create a bird class that will spawn birds at random intervals and move similarly to obstacles.
# - We will add animation also same as we did for the player.
