# 3.2 Creating Ground. Making the ground layer infinite then we will use sprite group to manage the ground layer.
...
# Note : There is a problem with the ground which is if the game runs for a long time, some gap will appear between the two ground images.
#       Which we  will fix in the next part.