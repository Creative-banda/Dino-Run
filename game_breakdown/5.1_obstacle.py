# 5.1 Creating Obstacles, We will create obstacles class which will be used to create obstacles in the game
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("assets/images/boxes/0.png")
