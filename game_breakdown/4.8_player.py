# 4.8 Creating Player, We will add a feauture to pull down if player is in air otherwise player will duck


# Task for you:
# - When  the player is in the air and presses down, they should pull down but now player is not able to jumpy properly, Try to figure about why and fix it.
...
class Player():
    def __init__(self):
        ...
        self.ducking = False  # New attribute for ducking state
