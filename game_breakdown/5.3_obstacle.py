# 5.3 Creating Obstacles, We will spawn the obstacles at random intervals and they will move towards the player
...
while running:
    ...
    if random.randint(1, 150) == 1:  # Adjust frequency of obstacles
        obstacle = Obstacle()
